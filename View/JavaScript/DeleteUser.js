...
if (deleteButton) {
    deleteButton.addEventListener("click", async function () {
        if (window.location.pathname.includes("WindowAdmin.html")) {
            ...
            selected = userList ? userList.options[userList.selectedIndex] : null;
            profileCode = selected ? (selected.dataset.profileCode || selected.value || selected.dataset.id) : "";
            id = selected ? (selected.dataset.id || selected.value || selected.dataset.profileCode) : "";
            uname = selected ? (selected.dataset.username || "") : "";
